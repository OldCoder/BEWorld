/*
 * little-endian, unscaled pixel routines
 */
#define B_ADJ 0
#define G_ADJ 1
#define R_ADJ 2
...
void rgb_frame_le(frame *, frame *, point *);
void rgba_frame_le(frame *, frame *, point *);
void hl_frame_le(frame *, frame *, point *);
void sl_frame_le(frame *, frame *, point *);
void br_frame_le(frame *, frame *, point *);
void ct_frame_le(frame *, frame *, point *);
void sat_frame_le(frame *, frame *, point *);
void displ_frame_le(frame *, frame *, point *);
void convo_frame_le(frame *, frame *, point *);
void lut_frame_le(frame *, frame *, point *);
void xor_frame_le(frame *, frame *, point *);
...
void rgb_frame_le_scaled(frame *, frame *, point *, dimensions *);
void rgba_frame_le_scaled(frame *, frame *, point *, dimensions *);
void hl_frame_le_scaled(frame *, frame *, point *, dimensions *);
void sl_frame_le_scaled(frame *, frame *, point *, dimensions *);
void br_frame_le_scaled(frame *, frame *, point *, dimensions *);
void ct_frame_le_scaled(frame *, frame *, point *, dimensions *);
void sat_frame_le_scaled(frame *, frame *, point *, dimensions *);
void displ_frame_le_scaled(frame *, frame *, point *, dimensions *);
void convo_frame_le_scaled(frame *, frame *, point *, dimensions *);
void lut_frame_le_scaled(frame *, frame *, point *, dimensions *);
void xor_frame_le_scaled(frame *, frame *, point *, dimensions *);
